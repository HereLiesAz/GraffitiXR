...
Jag var tvungen att uppfinna en anpassad Persistent Voxel Memory-motor som fungerar på Android utan hjälp av molnet - för graffiti är, du vet, olagligt.
...
Bara för skojs skull inkluderade jag icke-AR, bildöverlagringsfunktion för bildspårning, precis som du får med de andra apparna, om du föredrar det. Eller om du vill, det finns Mockup-läge. Ta en bild på väggen, så finns det några snabba verktyg för en snabb mockup. Och om du inte har något att bevisa vill du bara att något kopieras på papper perfekt, spårningsläget låter dig använda din telefon som en ljuslåda, hålla skärmen på med ljusstyrkan upphöjd, låsa bilden på plats och blockera alla beröringar tills du är klar.
...
* **Custom Engine (MobileGS):** C++17 inbyggd motor för Persistent Voxel Memory (ogenomskinliga surfels) och rumslig kartläggning.
