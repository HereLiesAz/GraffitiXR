...
Ho dovuto inventare un motore personalizzato di Persistent Voxel Memory che funziona su Android senza l'aiuto del cloud -- perché i graffiti sono, sapete, illegali.
...
*   **Motore Personalizzato (MobileGS):** Motore nativo C++17 per Persistent Voxel Memory (surfel opachi) e mappatura spaziale.
