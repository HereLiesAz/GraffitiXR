                                                                                            ...
                                                                                            withContext(dispatchers.main) {
                                                                                                                _uiState.update { state ->
                                                                                                                                        state.copy(layers = state.layers.map {
                                                                                                                                                                    if (it.id == layerId) it.copy(bitmap = currentBitmap) else it
                                                                                                                                        })
                                                                                                                }
                                                                        ...
                                                                        updateHistoryCounts()
                                                                                ...
                                                                                viewModelScope.launch(dispatchers.default) {
                                                                                                val mappedStroke = com.hereliesaz.graffitixr.feature.editor.util.ImageProcessor.mapScreenToBitmap(
                                                                                                                    command.path,
                                                                                                                    command.canvasSize.width,
                                                                                                                    command.canvasSize.height,
                                                                                                                    activeBitmap.width,
                                                                                                                    activeBitmap.height
                                                                                                                )
                                                                                                            ...
                                                                                                            val newBitmap = com.hereliesaz.graffitixr.feature.editor.util.ImageProcessor.applyToolToBitmap(
                                                                                                                        ...
                                                                                                                        withContext(dispatchers.main) {
                                                                                                                                            _uiState.update { state ->
                                                                                                                                                                    state.copy(layers = state.layers.map {
                                                                                                                                                                                                if (it.id == layerId) it.copy(bitmap = newBitmap) else it
                                                                                                                                                                    })
                                                                                                                                            }
                                                                                                                        }
                                                                                                                                                                                ...
                                                                                                                                                                                override fun onRotationZChanged(d: Float) { updateActiveLayer { it.copy(rotationZ = d) }; _uiState.update { it.copy(activeRotationAxis = RotationAxis.Z) } }
                                                                                                                                                                                    ...
                                                                                                                                                                                    override fun onCycleRotationAxis() {
                                                                                                                                                                                                val next = when (_uiState.value.activeRotationAxis) {
                                                                                                                                                                                                                RotationAxis.X -> RotationAxis.Y; RotationAxis.Y -> RotationAxis.Z; RotationAxis.Z -> RotationAxis.X
                                                                                                                                                                                                            }
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        override fun copyLayerModifications(id: String) {
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            override fun pasteLayerModifications(id: String) {
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        pushHistory()
                                                                                                                                                                                                                                _uiState.update { state ->
                                                                                                                                                                                                                                                state.copy(layers = state.layers.map {
                                                                                                                                                                                                                                                                    if (it.id == id) it.copy(opacity = source.opacity, brightness = source.brightness,
                                                                                                                                                                                                                                                                                                                 contrast = source.contrast, saturation = source.saturation,
                                                                                                                                                                                                                                                                                                                 colorBalanceR = source.colorBalanceR, colorBalanceG = source.colorBalanceG,
                                                                                                                                                                                                                                                                                                                 colorBalanceB = source.colorBalanceB, blendMode = source.blendMode,
                                                                                                                                                                                                                                                                                                                 warpMesh = source.warpMesh) else it
                                                                                                                                                                                                                                                                })
                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                        saveProject()
                                                                                                                                                                                                                                            }
